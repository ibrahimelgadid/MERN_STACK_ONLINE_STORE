  ...
  useEffect(() => {
    if (!isEmpty(user)) {
      ...
      if (!isEmpty(user.social)) {
        user.social.address = !isEmpty(user.social.address)
          ? setAddress(user.social.address)
          : "";
        ...
        user.social.facebook = !isEmpty(user.social.facebook)
          ...
          : "";
        user.social.twitter = !isEmpty(user.social.twitter)
          ? setTwitter(user.social.twitter)
          : "";
        user.social.instagram = !isEmpty(user.social.instagram)
