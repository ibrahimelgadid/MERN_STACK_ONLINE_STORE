...
import { getProducts, getProductsByBrand, getProductsByCategory } from '../../ReduxCycle/actions/ProductsActions';
...
function ProductByCategory() {
  ...
  let GetProductsByCategory = bindActionCreators( getProductsByCategory, dispatch);
                    ...
                    <div className="card-body text-center">
                      ...
                      <small className='text-muted'>from {product.brand}, as {product.category}</small>
                        <div className="btn-group btn-block mt-4" role={'group'}>
                          <Link to={`/cart/${product._id}`} className='btn btn-sm btn-primary'>
