    ...
    <div>
      <div className="row justify-content-center my-4">
        <div className="col-11 col-md-10">
          <button
            onClick={() => navigate(-1)}
            className="btn btn-sm btn-outline-dark d-block mb-2"
          >
          ...
          {loading && isEmpty(product) ? (
            ...
            <div className="card shadow">
              ...
              <div className="card-body">
                ...
                <p>
                  <strong>
                    <i className="fas fa-envelope"></i> Category:-{" "}
                  </strong>{" "}
                  <small className="text-muted">{product.category}</small>
                </p>
                <p>
                  <strong>
                    <i className="fas fa-user-tag"></i> Brand:-{" "}
                  </strong>{" "}
                ...
                <p>
                  ...
                  <small className=" badge bg-danger ">${product.price}</small>
                </p>
                <p>
                  <strong>
                    <i className="fas fa-user-tag"></i> Publisher:-{" "}
                  </strong>{" "}
                  <small className="text-muted">{product.publisher.name}</small>
                </p>
                <p>
                  <strong>
                    <i className="fas fa-calender"></i> Created at:-{" "}
                  </strong>{" "}
